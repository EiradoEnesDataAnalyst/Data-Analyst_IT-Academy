...
/* Barra di navigazione in alto Blu Navy! */
.navbar { 
  background-color: #003366 !important; 
}

/* Autore sotto il titolo nella Navbar (allineato a sinistra) */
...
/* Stile globale per le spiegazioni dei grafici (Riquadri Crema) */
.custom-cream-box {
  text-align: center !important;
  border: 2px solid #B0B0B0 !important;
  padding: 35px !important;
  border-radius: 15px !important;
  background-color: #FFF8E7 !important; /* Color Crema */
...
/* Stile a riquadro per i testi introduttivi (Titoli pagina) */
.intro-text {
  text-align: center;
  margin: 30px auto;
  max-width: 1000px;
  background-color: #FFF8E7; /* Sfondo panna come richiesto */
  border: 2px solid #B0B0B0; /* Bordo grigio tenue come richiesto */
  border-radius: 15px;       /* Angoli tondi */
  padding: 25px 40px;        /* Spazio interno per far respirare il testo */
  box-shadow: 0px 6px 15px rgba(0, 0, 0, 0.08); /* Leggera ombra 3D */
}
...
::: {.intro-text}
<h3>THE TRANSITION PARADOX: POWER GRID VS REAL ECONOMY</h3>
