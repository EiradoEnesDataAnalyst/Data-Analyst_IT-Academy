...
This data package contains the data that powers the chart ["World Bank income groups"](https://ourworldindata.org/grapher/world-bank-income-groups?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on April 9, 2026.
